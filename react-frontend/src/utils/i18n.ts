...
const resources = {
        en:{
            translation:{
                ...
                update_candidate_name:"Enter new candidate name (leave blank to keep current):",
                edit:"Edit",
                delete:"Del",
                generate:"Generate",
        ...
        mm: {
            translation: {
                ...
                wanna_delete_candidate:"ဤကိုယ်စားလှယ်လောင်းအား ဖျက်ရန် သေချာပါသလား? ဤလုပ်ဆောင်ချက်ကို ပြန်လည်လုပ်ဆောင်၍မရနိုင်ပါ။",
                candidates:"ကိုယ်စားလှယ်လောင်းများ",
                update_candidate_name:"ကိုယ်စားလှယ်လောင်း အမည်အသစ်ထည့်သွင်းပါ (လက်ရှိအမည်အတိုင်းထားရန် ဖောင်ကို အလွတ်ထားနိုင်သည်):",
                edit:"ပြင်ဆင်မည်",
                delete:"ဖျက်သိမ်းမည်",
                generate:"ဖန်တီးရန်",
                ...
                accounts_generated:"မဲပေးသူ အကောင့်များကို အောင်မြင်စွာ ဖန်တီးပြီးပါပြီ။",
                download:"CSV ဒေါင်းလုပ်လုပ်ရန်",
                refresh:"ပြန်လည်သွင်းယူမည်",
                no_accounts:"အကောင့်များ မရှိသေးပါ။ ဖန်တီးမည် သို့မဟုတ် ပြန်လည်သွင်းယူပါ။",
